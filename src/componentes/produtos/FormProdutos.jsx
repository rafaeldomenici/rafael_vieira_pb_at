        ...
        <>
            <div className="container">
                <form onSubmit={handleSubmit(submeterDados)}>
                    <label className="formLabel label2" htmlFor="nomeProduto">Nome do Produto</label>&nbsp;
                    ...
                    <br />
                    <label className="formLabel label2" htmlFor="descricao">Descrição</label>&nbsp;
                    ...
                    <select style={{width: "209px", marginLeft: "3px"}} {...register("fornecedor")}>
