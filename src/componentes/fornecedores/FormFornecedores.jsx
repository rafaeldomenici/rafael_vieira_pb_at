        ...
        <>
            <div className="container">
                <form onSubmit={handleSubmit(submeterDados)}>
                    <label className="formLabel label2" htmlFor="nomeFantasia">Nome de Fantasia</label>&nbsp;
                    ...
                    <br />
                    <label className="formLabel label2" htmlFor="razaoSocial">Razão Social</label>&nbsp;
                    ...
                    <br />
                    <label className="formLabel label2" htmlFor="cnpj">CNPJ</label>&nbsp;
                    ...
                    <br />
                    <input style={{ marginTop: "70px", marginRight: "10px",display: "inline-block" }} type="submit" value="Salvar" />
                    <input style={{ marginTop: "70px", display: "inline-block" }} type="button" value="Excluir" onClick={handleExcluir} />
                </form>
            </div>
